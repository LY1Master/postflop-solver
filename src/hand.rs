    ...
    pub fn alpha(&self, position: usize, bucket: HandBucket) -> f64 {
        ...
        match self.texture {
            BoardTexture::Trips => match (is_oop, bucket) {
                (true, HandBucket::MonsterMade) => 1.50,
                (false, HandBucket::MonsterMade) => 1.30,
                (true, HandBucket::MediumMade) => 1.18,
                (false, HandBucket::MediumMade) => 0.91,
                (true, HandBucket::WeakDraw) => 0.90,
                (true, HandBucket::Trash) => 0.82,
                _ => 1.0,
            },
            BoardTexture::PairedRainbow => match (is_oop, bucket) {
                (true, HandBucket::MonsterMade) => 1.23,
                (false, HandBucket::MonsterMade) => 1.10,
                (true, HandBucket::MediumMade) => 0.81,
                (false, HandBucket::MediumMade) => 0.87,
                (true, HandBucket::WeakDraw) => 0.84,
                (false, HandBucket::WeakDraw) => 1.49,
                (true, HandBucket::Trash) => 0.65,
                (false, HandBucket::Trash) => 0.97,
                _ => 1.0,
            },
            BoardTexture::PairedTwoTone => match (is_oop, bucket) {
                (true, HandBucket::MonsterMade) => 1.16,
                (false, HandBucket::MonsterMade) => 1.07,
                (true, HandBucket::MediumMade) => 0.82,
                (false, HandBucket::MediumMade) => 0.96,
                (true, HandBucket::StrongDraw) => 1.01,
                (false, HandBucket::StrongDraw) => 1.18,
                (true, HandBucket::WeakDraw) => 0.77,
                (false, HandBucket::WeakDraw) => 1.13,
                (true, HandBucket::Trash) => 0.72,
                (false, HandBucket::Trash) => 1.03,
                _ => 1.0,
            },
            BoardTexture::Rainbow => match (is_oop, bucket) {
                (true, HandBucket::MonsterMade) => 1.28,
                (false, HandBucket::MonsterMade) => 1.36,
                (true, HandBucket::GoodTopPair) => 1.02,
                (false, HandBucket::GoodTopPair) => 1.01,
                (true, HandBucket::MediumMade) => 0.75,
                (false, HandBucket::MediumMade) => 0.79,
                (true, HandBucket::StrongDraw) => 0.98,
                (false, HandBucket::StrongDraw) => 1.42,
                (true, HandBucket::WeakDraw) => 0.96,
                (true, HandBucket::Trash) => 0.65,
                (false, HandBucket::Trash) => 0.66,
                _ => 1.0,
            },
            BoardTexture::TwoToneA => match (is_oop, bucket) {
                (true, HandBucket::MonsterMade) => 1.18,
                (false, HandBucket::MonsterMade) => 1.22,
                (true, HandBucket::GoodTopPair) => 0.93,
                (false, HandBucket::GoodTopPair) => 0.95,
                (true, HandBucket::MediumMade) => 0.74,
                (false, HandBucket::MediumMade) => 0.84,
                (true, HandBucket::MonsterDraw) => 1.22,
                (false, HandBucket::MonsterDraw) => 1.36,
                (true, HandBucket::StrongDraw) => 0.98,
                (false, HandBucket::StrongDraw) => 1.39,
                (true, HandBucket::WeakDraw) => 0.90,
                (true, HandBucket::Trash) => 0.62,
                (false, HandBucket::Trash) => 0.73,
                _ => 1.0,
            },
            BoardTexture::TwoToneB => match (is_oop, bucket) {
                (true, HandBucket::MonsterMade) => 1.21,
                (false, HandBucket::MonsterMade) => 1.26,
                (true, HandBucket::GoodTopPair) => 0.94,
                (false, HandBucket::GoodTopPair) => 0.96,
                (true, HandBucket::MediumMade) => 0.74,
                (false, HandBucket::MediumMade) => 0.83,
                (true, HandBucket::MonsterDraw) => 1.22,
                (false, HandBucket::MonsterDraw) => 1.18,
                (true, HandBucket::StrongDraw) => 0.97,
                (false, HandBucket::StrongDraw) => 1.37,
                (true, HandBucket::WeakDraw) => 0.90,
                (true, HandBucket::Trash) => 0.60,
                (false, HandBucket::Trash) => 0.72,
                _ => 1.0,
            },
            BoardTexture::MonotoneA => match (is_oop, bucket) {
                (true, HandBucket::MonsterMade) => 1.17,
                (false, HandBucket::MonsterMade) => 1.14,
                (true, HandBucket::GoodTopPair) => 0.77,
                (false, HandBucket::GoodTopPair) => 0.78,
                (true, HandBucket::MediumMade) => 0.71,
                (false, HandBucket::MediumMade) => 0.80,
                (true, HandBucket::MonsterDraw) => 1.10,
                (false, HandBucket::MonsterDraw) => 1.14,
                (true, HandBucket::StrongDraw) => 0.85,
                (true, HandBucket::Trash) => 0.62,
                (false, HandBucket::Trash) => 0.64,
                _ => 1.0,
            },
            BoardTexture::MonotoneB => match (is_oop, bucket) {
                (true, HandBucket::MonsterMade) => 1.17,
                (false, HandBucket::MonsterMade) => 1.12,
                (true, HandBucket::GoodTopPair) => 0.73,
                (false, HandBucket::GoodTopPair) => 0.77,
                (true, HandBucket::MediumMade) => 0.76,
                (false, HandBucket::MediumMade) => 0.81,
                (true, HandBucket::MonsterDraw) => 0.96,
                (false, HandBucket::MonsterDraw) => 0.84,
                (true, HandBucket::StrongDraw) => 1.08,
                (false, HandBucket::StrongDraw) => 1.18,
                (true, HandBucket::Trash) => 0.68,
                (false, HandBucket::Trash) => 0.95,
                _ => 1.0,
            },
        }
    }
